...
object SaveTweets {
  ...
  def main(args: Array[String]) {
    ...
    // But let's do it the hard way to get more control
    ...
    statuses.foreachRDD((rdd, time) => {
      ...
      if (rdd.count() > 0) {
        ...
        // Stop once we've collected 250 tweets
    ...
    // You can also write results into a database of your choice, but we'll do that later.
